...
images_n_vids_path = "D:/data science/git_Car_Plate_Detection/images_vids"
video_n_vids_path = "D:/data science/git_Car_Plate_Detection/images_vids"
image_path = os.path.join(images_n_vids_path, "pelakir_2.jpg")
video_path = os.path.join(video_n_vids_path, "test_video_short.mp4")

savepath = "D:/data science/git_Car_Plate_Detection/sidebar"
